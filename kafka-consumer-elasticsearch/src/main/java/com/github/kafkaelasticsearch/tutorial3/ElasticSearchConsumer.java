package com.github.kafkaelasticsearch.tutorial3;
...
public class ElasticSearchConsumer {
    ...
    public static RestHighLevelClient createClient(){
        ...
        String hostname = dotenv.get("BONSAIHOSTNAME"); // localhost or bonsai url
        String username = dotenv.get("BONSAIUSERNAME"); // needed only for bonsai
        String password = dotenv.get("BONSAIPASSWORD"); // needed only for bonsai
